...
int main(int argc, char **argv) {
    ...
    std::string data_output_path = ros::package::getPath("exercise6");
    std::string datafile_1 = data_output_path + "/exercise6_robot1.csv";
    std::string datafile_2 = data_output_path + "/exercise6_robot2.csv";
    std::ofstream f1(datafile_1);
    std::ofstream f2(datafile_2);
    double t0 = NAN;
